...
<div class="pb-16">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ school_route('school_admin.teachers.create') }}" class="bg-indigo-600 text-white px-4 py-2 rounded-lg hover:bg-indigo-700">
            + Add Teacher
        </a>
    </div>
            ...
            <tbody class="divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 text-right space-x-2">
                        <a href="{{ school_route('school_admin.teachers.edit', $teacher) }}" class="text-green-600 hover:text-green-800">Edit</a>
                        <form action="{{ school_route('school_admin.teachers.destroy', $teacher) }}" method="POST" class="inline">
                            @csrf @method('DELETE')
