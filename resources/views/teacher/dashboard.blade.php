...
<div class="pb-16">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
        <div class="lg:col-span-1 space-y-4">
            <a href="{{ school_route('teacher.classrooms.index') }}" class="block bg-indigo-600 text-white p-4 rounded-lg hover:bg-indigo-700 transition text-center">
                <svg class="w-8 h-8 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path>
                </svg>
                จัดการห้องเรียน
            </a>
            <a href="{{ school_route('teacher.students.index') }}" class="block bg-green-600 text-white p-4 rounded-lg hover:bg-green-700 transition text-center">
                <svg class="w-8 h-8 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path>
                </svg>
                จัดการนักเรียน
            </a>
            <a href="{{ school_route('teacher.parents.index') }}" class="block bg-yellow-600 text-white p-4 rounded-lg hover:bg-yellow-700 transition text-center">
                <svg class="w-8 h-8 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path>
                </svg>
                จัดการผู้ปกครอง
            </a>
            <a href="{{ school_route('teacher.links.index') }}" class="block bg-purple-600 text-white p-4 rounded-lg hover:bg-purple-700 transition text-center">
                <svg class="w-8 h-8 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1"></path>
                </svg>
                เชื่อมโยงผู้ปกครอง
            </a>
            <a href="{{ school_route('teacher.upload.create') }}" class="block bg-red-600 text-white p-4 rounded-lg hover:bg-red-700 transition text-center">
                <svg class="w-8 h-8 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                </svg>
                อัปโหลดไฟล์
                    ...
                    <div class="space-y-3 max-h-[28rem] overflow-y-auto pr-2">
                        @foreach($recentMedia as $media)
                            <div class="flex items-center p-3 bg-gray-50 rounded-lg group">
                                ...
                                <form action="{{ school_route('teacher.media.destroy', ['media' => $media]) }}" method="POST" class="delete-form">
                                    @csrf
                                    @method('DELETE')
