...
<div class="max-w-2xl mx-auto">
    ...
    <div class="bg-white rounded-lg shadow p-6">
        ...
        <form action="{{ school_route('teacher.classrooms.store') }}" method="POST">
            @csrf
            ...
            <div class="flex justify-end space-x-3">
                <a href="{{ school_route('teacher.classrooms.index') }}" class="px-4 py-2 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-50">
                    ยกเลิก
                </a>
