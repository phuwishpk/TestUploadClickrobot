...
<div class="mb-6 flex justify-between items-center">
    ...
    <a href="<?php echo e(route('teacher.students.create')); ?>" class="bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700">
        + เพิ่มนักเรียน
    </a>
</div>

<div class="mb-4">
    <form method="GET" action="<?php echo e(route('teacher.students.index')); ?>" class="flex items-center space-x-4">
        ...
        <tbody class="bg-white divide-y divide-gray-200">
            <?php $__empty_1 = true; $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-gray-600"><?php echo e($student->classroom->name ?? '-'); ?></td>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm">
                        <a href="<?php echo e(route('teacher.students.show', $student)); ?>" class="text-indigo-600 hover:underline mr-3">ดู</a>
                        <a href="<?php echo e(route('teacher.students.edit', $student)); ?>" class="text-green-600 hover:underline mr-3">แก้ไข</a>
                        <form action="<?php echo e(route('teacher.students.destroy', $student)); ?>" method="POST" class="inline">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/teacher/students/index.blade.php ENDPATH**/ ?>