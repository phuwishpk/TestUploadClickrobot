...
<div class="max-w-2xl mx-auto">
    ...
    <div class="bg-white rounded-lg shadow p-6">
        ...
        <form action="<?php echo e(route('school_admin.students.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            ...
            <div class="mb-4">
                <label class="flex items-center">
                    <input type="checkbox" name="create_account" value="1" <?php echo e(old('create_account') ? 'checked' : ''); ?>
                        ...
                        class="w-4 h-4 text-indigo-600 rounded" id="create_account_checkbox">
                    <span class="ml-2 text-sm text-gray-700">สร้างบัญชีให้นักเรียน (เข้าสู่ระบบได้)</span>
                </label>
                <p class="mt-1 text-xs text-gray-500 ml-6">รหัสผ่านเริ่มต้น: 12345</p>
            </div>

            <div id="account_fields" class="<?php echo e(old('create_account') ? '' : 'hidden'); ?> bg-blue-50 p-4 rounded-lg mb-4">
                <div class="mb-4">
                    <label for="email" class="block text-sm font-medium text-gray-700 mb-1">อีเมลสำหรับเข้าสู่ระบบ <span class="text-red-500">*</span></label>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="flex justify-end space-x-3">
                <a href="<?php echo e(route('school_admin.students.index')); ?>" class="px-4 py-2 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-50">
                    ยกเลิก
                </a>
...
<script>
document.getElementById('create_account_checkbox').addEventListener('change', function() {
    document.getElementById('account_fields').classList.toggle('hidden', !this.checked);
});
</script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/school_admin/students/create.blade.php ENDPATH**/ ?>