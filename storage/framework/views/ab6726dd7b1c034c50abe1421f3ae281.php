...
<div class="pb-16">
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <form action="<?php echo e(route('school_admin.classrooms.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div class="space-y-4">
                <div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/school_admin/classrooms/create.blade.php ENDPATH**/ ?>