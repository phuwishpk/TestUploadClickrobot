<?php $__env->startSection('title', 'ไฟล์ของบุตรหลาน'); ?>
        ...
        <select name="student_id" onchange="this.form.submit()" class="border border-gray-300 rounded px-3 py-1">
            ...
            <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($student->id); ?>" <?php echo e($selectedStudentId == $student->id ? 'selected' : ''); ?>>
                    <?php echo e($student->name); ?> (<?php echo e($student->classroom->name ?? ''); ?>)
                </option>
...
<?php if($media->count() > 0): ?>
    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
        <?php $__currentLoopData = $media; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a href="<?php echo e(route('parent.media.show', $m)); ?>" class="block">
                <div class="bg-white rounded-lg shadow overflow-hidden hover:shadow-md transition">
                    ...
                    <?php endif; ?>
                    <div class="p-3">
                        <p class="text-sm font-medium"><?php echo e($m->student->name); ?></p>
                        <p class="text-xs text-gray-400 truncate"><?php echo e($m->original_name); ?></p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/parent/media/index.blade.php ENDPATH**/ ?>